...
export default function SetupScreen() {
  ...
  const handleGetStarted = async () => {
    ...
    try {
      ...
      try {
        const settingsData = await authService.getSettings(
      ...
      if (existing) {
        // Vendor exists → login
        const { vendor, token } = await authService.loginVendor(
          selectedProject.baseUrl,
          {
        ...
        {walletError ? (
          ...
          <>
            ...
            <Text style={styles.checkingSub}>
              Checking Google Drive for existing wallet
            </Text>
          </>
        )}
      </View>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={styles.fieldGroup}>
          {projectSelectError ? (
            <Text style={styles.errorText}>{projectSelectError}</Text>
          ) : null}
                  ...
                  >
                    <View style={styles.projectItemLeft}>
                      <View
                        style={[
                          styles.projectDot,
                          selected && styles.projectDotSelected,
                        ]}
                      />
                      <View>
                        <Text
                          style={[
                            styles.projectName,
                            selected && styles.projectNameSelected,
                          ]}
                        >
                          {project.name}
                        </Text>
        ...
        <TouchableOpacity
          style={[
            styles.submitBtn,
            { marginTop: 28 },
            !selectedProject && styles.submitBtnDisabled,
          ]}
