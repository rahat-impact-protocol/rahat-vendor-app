// CVAProject (disbursementContract) — beneficiary claim balance mapping.
// beneficiaryClaims[beneficiaryAddress] → uint256 (whole token units, not wei)
export const CVA_PROJECT_ABI = [
  {
