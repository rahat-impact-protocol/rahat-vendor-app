...
export const MOCK_TRANSACTIONS: Transaction[] = [
  {
    id: 'tx-001', amount: '12 Rahat', tokenAmount: 12,
    hash: '0x5e68...37455', date: 'Jan 1 · 12:30 PM',
    mode: 'offline', status: 'completed',
    beneficiaryPhone: '9800000001', beneficiaryName: 'Aadarsha L.', projectId: 'p-001',
  },
  {
    id: 'tx-002', amount: '25 Rahat', tokenAmount: 25,
    hash: '0x9a21...88fc1', date: 'Jan 2 · 09:15 AM',
    mode: 'online', status: 'completed',
    beneficiaryPhone: '9800000002', beneficiaryName: 'Rama K.', projectId: 'p-001',
  },
  {
    id: 'tx-003', amount: '8 Rahat', tokenAmount: 8,
    hash: '0x3b77...21d44', date: 'Jan 3 · 03:40 PM',
    mode: 'offline', status: 'pending',
    beneficiaryPhone: '9800000003', beneficiaryName: 'Sita M.', projectId: 'p-001',
  },
  {
    id: 'tx-004', amount: '30 Rahat', tokenAmount: 30,
    hash: '0xc44a...9f2bb', date: 'Jan 4 · 11:00 AM',
    mode: 'online', status: 'completed',
    beneficiaryPhone: '9800000004', beneficiaryName: 'Bikram T.', projectId: 'p-001',
  },
  {
    id: 'tx-005', amount: '15 Rahat', tokenAmount: 15,
    hash: '0x1f93...562e7', date: 'Jan 5 · 08:20 AM',
    mode: 'offline', status: 'completed',
    beneficiaryPhone: '9800000005', beneficiaryName: 'Gita S.', projectId: 'p-001',
  },
  {
    id: 'tx-006', amount: '5 Rahat', tokenAmount: 5,
    hash: '0x7d82...a1e33', date: 'Jan 6 · 02:05 PM',
